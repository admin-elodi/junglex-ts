  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-64 bg-black/90 border-r border-emerald-600 p-4">
      ...
      <nav className="space-y-3 text-sm">
        <Link to="/app/dashboard" className="block">Dashboard</Link>
        <Link to="/app/feed" className="block">Feed</Link>
        <Link to="/app/profile" className="block">Profile</Link>
        ...
        <Link to="/app/bookmarks" className="block">Bookmarks</Link>
      </nav>
      ...
      <div className="mt-8 border-t border-emerald-700 pt-4 text-xs text-gray-400 space-y-2">
        ...
        <Link to="/cookies" className="block">Cookies</Link>
      </div>
